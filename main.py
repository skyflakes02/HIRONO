...
class BattleCity:
    ...
    def handle_bomb_collision(self):
        for bullets in self.enemy_tank_2.tank_type:
    ...
    def draw(self):
        ...
        pyxel.text(65, 2, f"KILLS: {self.enemy_tank_1_count or self.enemy_tank_2_count}", 8)
